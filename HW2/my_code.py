...
seq_2 = "ATCGACTCGAGTCGTACGTTCACG"
print(gc_content(seq_2))

seq_31 = "AAAAAAAAA"
motif_31 = "AA"
print(find_motif_freq(motif_31,seq_31))

seq_32 = "ACTGACTATCGTCAGTCGATCTAATCCTG"
motif_32 = "ATC"
print(find_motif_freq(motif_32,seq_32))

seq_4 = "ACTCGACTCAGCATCATACGGACTC"
bind = "ATGC"
print(find_binding_site(bind,seq_4))
...
def roll_until_repeat(n_sided, trials=1000000):
    ...
    total_rolls = 0
    num_rolls_per_trial = 10    # this is the number of rolls
    for i in range(trials):
    ...
    return avg
print(num_die_sum(1,3))
print(correct_papers(10))
print(monte_carlo_pi(100000))
print(roll_until_repeat(6,2))
